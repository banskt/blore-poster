...
\begin{multicols}{2}
  ...
  \begin{tabular}{c p{2em} c}
    \adjustbox{valign=m}{\includegraphics[height=15em]{Locus_013_ldexample.pdf}} & &
  ...
  \begin{itemize}
    ...
    \item Limited to application on each individual genome-wide significant locus
  \end{itemize} 
  \,\\[0.5em]
\end{multicols}

%\begin{tabular}{ccl}
%  { \specialcell{\includegraphics[height=15em]{Locus_013_ldexample.pdf} \\ Linkage disequilibrium \faFrownO} &
%  { \specialcell{\includegraphics[height=15em]{linear_model.pdf} \\ Linear model \faFrownO} &
