...
def banskt_presentation(black = '#333333', linewidth = 2, ticksize = 8, fontsize = 28, padding = 10, fontfamily = 'latex', colors = 'banskt'):
    ...
    if fontfamily == 'latex':
        ...
        matplotlib.rcParams['text.latex.preamble'] = [#r'\usepackage[sfdefault,scaled=.85, lining]{FiraSans}',
                                                      r'\usepackage{helvet}',
                                                      r'\usepackage[scaled=1.06,sups,osf]{XCharter}',
                                                      r'\usepackage[charter,vvarbb,scaled=1.1]{newtxmath}',
                                                      r'\usepackage[cal=cm, scr=rsfso]{mathalfa}',
    ...
    elif fontfamily == 'latex-poster':
        matplotlib.rcParams['font.family'] = 'sans-serif'
        matplotlib.rcParams['text.latex.preamble'] = [r'\usepackage{helvet}',
                                                      r'\usepackage[charter,expert]{mathdesign}', 
                                                      r'\usepackage[scaled=1.06,sups,osf]{XCharter}',
                                                      r'\usepackage[charter,vvarbb,scaled=1.1]{newtxmath}',
                                                      r'\DeclareMathAlphabet{\pazocal}{OMS}{zplm}{m}{n}',
                                                      r'\renewcommand{\mathcal}[1]{\pazocal{#1}}']
